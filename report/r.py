...
##	if (sumT1[0] == "Wed" or sumT1[0] == "Mon" or sumT1[0] == "Thu" or sumT1[0] == "Fri" or sumT1[0] == "Tue") and sumT1[5] == "2019":
...
##for line in f2:
  ##      sumT2 = line.strip().split(" ")
    ##    if (sumT2[0] == "Wed" or sumT2[0] == "Mon" or sumT2[0] == "Thu" or sumT2[0] == "Fri" or sumT2[0] == "Tue") and sumT2[5] == "2019":
...
##for line in f3:
  ##      sumT3 = line.strip().split(" ")
    ##    if (sumT3[0] == "Wed" or sumT3[0] == "Mon" or sumT3[0] == "Thu" or sumT3[0] == "Fri" or sumT3[0] == "Tue") and sumT3[5] == "2019":
...
##for line in f5:
  ##      sumT5 = line.strip().split(" ")
    ##    if (sumT5[0] == "Wed" or sumT5[0] == "Mon" or sumT5[0] == "Thu" or sumT5[0] == "Fri" or sumT5[0] == "Tue") and sumT5[5] == "2019":
